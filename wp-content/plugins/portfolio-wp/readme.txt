...
Tags: portfolio, gallery, portfolio gallery, video gallery, portfolio slider
...
GridKit is an Ultimate Visual Media Grid builder designed for a portfolio, gallery, video gallery, product catalog or gallery slider creation. GridKit Portfolio Gallery comes with number of features and this are the just few mostly used by clients:
...
* Vimeo video gallery
* WordPress native video gallery
* Clients portfolio gallery
* Sponsors logo gallery
* Team members gallery  
* Image popup, video popup, maps popup, iFrame popup
* Social share buttons, e.g. Facbeook, Twitter...
...
* [Demo 5](http://wpsofts.com/grid-kit-demo/client-logos/) » Clients portfolio
* [Demo 6](http://wpsofts.com/grid-kit-demo/client-logos/) » Sponsors gallery
* [Demo 7](http://wpsofts.com/grid-kit-demo/team-members/) » Team members gallery
* [Demo 8](http://wpsofts.com/grid-kit-demo/video-gallery/) » YouTube video gallery
* [Demo 9](http://wpsofts.com/grid-kit-demo/vimeo-video-gallery/) » Vimeo video gallery
* [Demo 10](http://wpsofts.com/grid-kit-demo/local-video-gallery/) » Local video gallery
* [Demo 11](http://wpsofts.com/grid-kit-demo/mixed-video-photo-content/) » Gallery photos & videos
* [Demo 12](http://wpsofts.com/grid-kit-demo/layout-styles/?layout=3) » Grid style 1 (gallery)
* [Demo 13](http://wpsofts.com/grid-kit-demo/layout-styles/?layout=2) » Grid style 2 (masonry)
* [Demo 14](http://wpsofts.com/grid-kit-demo/layout-styles/?layout=1) » Grid style 3 (puzzle)
* [Demo 15](http://wpsofts.com/grid-kit-demo/gallery-with-iframe-popup/) » Gallery with iFrame popup
* [Demo 15](https://wpsofts.com/grid-kit-demo/gallery-with-map-popup/) » Gallery with Google maps popup
* [Demo 16](http://wpsofts.com/grid-kit-demo/social-sharing/) » Social share buttons, e.g. Facebook, Twitter
* [Demo 17](http://wpsofts.com/grid-kit-demo/category-filtration/) » Portfolio with categories
* [Demo 18](http://wpsofts.com/grid-kit-demo/paging/) » Gallery pictures pagination
* [Demo 19](http://wpsofts.com/grid-kit-demo/lazy-loading/) » Gallery pictures lazy loading
* [Demo 20](http://wpsofts.com/grid-kit-demo/styles/?t=image-hover-animations) » 7+ gallery image effects
* [Demo 21](http://wpsofts.com/grid-kit-demo/styles/?t=hover-overlay-animations) » 24+ image overlay effects
* [Demo 22](http://wpsofts.com/grid-kit-demo/styles/?t=title-description-display-styles) » 25+ portfolio details appearance
* [Demo 23](http://wpsofts.com/grid-kit-demo/styles/?t=hover-buttons-animations) » 14+ hover buttons appearance
* [Demo 24](http://wpsofts.com/grid-kit-demo/styles/?t=social-buttons-display-styles) » 24+ share buttons appearance
* [Demo 25](http://wpsofts.com/grid-kit-demo/styles/?t=category-bar-styles) » 10+ category bar styles
* [Demo 26](http://wpsofts.com/grid-kit-demo/styles/?t=pagination-bar-styles) » 10+ pagination bar styles
...
* Team members gallery
* Gallery image popup
* 1 grid style (Note: Masonry & Puzzle are included in Premium)
* Easy gallery grid composer
...
* Category filters for portfolio projects or gallery items
* Gallery items pagination
* Gallery items lazy loading
* Ajax gallery reloading
* Banner slider
* Portfolio project sharing
* Gallery sharing
* Captions for gallery pictures
* Gallery loading progress bar
* Portfolio slideshow
* Zoomable gallery
* FULL CONTROL ON DESIGN & OPTIONS CUSTOMIZATION
* Excellent dedicated support
* And many many more... 

= Detailed Description =

GridKit Portfolio Gallery designed for composing portfolio, gallery, photo album, image slider, eCommerce product catalog, video gallery media grids within fluid layouts. It fits the entire content inside the container without stretching your pictures. It provides the most popular 3 layout styles ( gallery, masonry, puzzle ). It also supports image, iFrame, video, maps embedded popups. There are more then 100+ predefined effects and animations which are of course customizable. With GridKit Portfolio Gallery you'll be able to showcase your portfolio project titles, descriptions, links or magnification buttons on hover actions. It also supports gallery category filtration & pagination. GridKit Portfolio Gallery will make your portfolio projects or gallery pictures one click shareable. of course native WordPress short-codes supported too. 
